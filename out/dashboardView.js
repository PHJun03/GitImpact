...
class SidebarProvider {
    _extensionUri;
    _analyzeCallback;
    static viewType = "gitImpact.dashboardView";
    _view;
    constructor(_extensionUri, _analyzeCallback) {
        this._extensionUri = _extensionUri;
        this._analyzeCallback = _analyzeCallback;
    }
    ...
    _getLoadingHtml(isLoading, error) {
