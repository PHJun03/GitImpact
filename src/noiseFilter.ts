...
/** A named filtering rule: a regex and a human-readable description. */
 ...
 */
const NOISE_RULES: readonly FilterRule[] = [
 ...
 */
export function filterLines(lines: readonly string[]): string[] {
 ...
 */
export function getNoiseBreakdown(
